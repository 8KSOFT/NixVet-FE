  ...
  return (
    <main className="overflow-hidden">
      ...
      <section className="relative flex h-screen min-h-175 items-start justify-start bg-brand-deep">
        ...
        <div className="relative flex flex-col justify-between h-[calc(100%-200px)] w-[90%] top-40 z-10 mx-auto lg:top-55 md:top-40 sm:top-40 lg:w-[80%] md:w-[80%] sm:w-[80%] lg:h-fit">
          <div>
            <RevealOnScroll>
      ...
      <section className="relative h-[160vh] min-h-375 flex flex-col items-start justify-start bg-brand-deep lg:h-screen lg:min-h-0">
        <div className="absolute top-45 -right-104 z-10 w-200 pointer-events-none select-none lg:-top-25 lg:right-40">
          {isMobile ? (
        ...
        <div className="absolute top-0 -left-15 w-full h-200 rounded-[45px] bg-linear-to-b from-black/25 via-black/5 to-transparent blur-sm pointer-events-none lg:-left-140 lg:top-6 lg:h-screen" />
        <div className="relative w-[80%] top-5 left-0 z-10 mx-auto lg:w-[50%] md:w-[60%] sm:w-[80%] lg:left-10 md:left-10 sm:left-10 lg:top-35">
          <RevealOnScroll>
            <h1 className="text-white text-[32px] font-bold leading-tight mb-6 lg:text-[59.61px] md:text-[32px] sm:text-[32px]">
        ...
        <div className="relative w-full top-100 z-10 mx-auto lg:top-75 lg:w-[80%] md:w-[80%] sm:w-[80%]">
          <div className="flex flex-wrap items-center justify-center gap-8">
            {FEATURES.map((feature, featureIndex) => {
              ...
              return (
                ...
                >
                  <Card className="group w-80 h-54 rounded-2xl shadow-sm transition-all duration-300 hover:border-primary/20 hover:shadow-md hover:-translate-y-1 lg:h-59.25 md:h-59.25 sm:h-59.25 lg:w-90 md:w-75 sm:w-50">
