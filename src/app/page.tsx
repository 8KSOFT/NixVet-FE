  ...
  return (
    <main className="overflow-hidden">
      ...
      <section className="relative h-screen flex flex-col items-start justify-start bg-brand-deep">
        ...
        <div className="relative w-[80%] top-35 left-0 z-10 mx-auto lg:w-[50%] md:w-[60%] sm:w-[80%] lg:left-10 md:left-10 sm:left-10">
          <RevealOnScroll>
            ...
            {FEATURES.map((feature, featureIndex) => {
              ...
              return (
                <RevealOnScroll key={feature.title} delayClassName={transitionDelayClassName}>
                  <Card className="group w-90 h-59.25 rounded-2xl shadow-sm transition-all duration-300 hover:border-primary/20 hover:shadow-md hover:-translate-y-1 sm:w-50 md:w-75 lg:w-90">
