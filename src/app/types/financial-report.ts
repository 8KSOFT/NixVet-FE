...
/** Linha do DRE comparativo (período atual vs anterior). */
export interface DREDiff {
  current: number;
  previous: number;
  diff_amount: number;
...
export type DRECompareMode = 'none' | 'prev_month' | 'prev_year';
