...
export default function PrescriptionsPage() {
  ...
  return (
    <div>
            ...
            <TableBody>
              {prescriptions.map((record) => (
                <TableRow key={record.id}>
                  ...
                  <TableCell>{record.prescription_type === 'solicitacao_cirurgia' ? 'Cirurgia' : 'Receita'}</TableCell>
                  <TableCell>
      ...
      >
        <form id="prescription-form" onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          {/* Paciente */}
