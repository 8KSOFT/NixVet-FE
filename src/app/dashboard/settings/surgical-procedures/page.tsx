            ...
            <Table className="min-w-full border-collapse bg-white text-sm">
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="border-l border-slate-200 px-3 py-2 text-left text-[11px] uppercase tracking-[0.12em] text-slate-600 w-[60px]" />
                </TableRow>
              </TableHeader>
              <TableBody>
                {prices.length === 0 && (
              ...
              <Table className="min-w-full border-collapse bg-white text-sm">
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="border-l border-slate-200 px-3 py-2 text-left text-[11px] uppercase tracking-[0.12em] text-slate-600">Custo</TableHead>
                    ...
                    <TableHead className="border-l border-slate-200 px-3 py-2 text-left text-[11px] uppercase tracking-[0.12em] text-slate-600 w-[140px]">Ações</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {list.map((r) => {
                    ...
                    return (
                      <TableRow key={r.id}>
                        ...
                        <TableCell className="border border-slate-200 px-3 py-3 text-slate-600">{r.surgical_procedure_category?.name ?? r.surgical_procedure_category_id ?? '—'}</TableCell>
                        <TableCell className="border border-slate-200 px-3 py-3 text-slate-600">{fmtBRL(r.private_price)}</TableCell>
                        <TableCell className="border border-slate-200 px-3 py-3 text-slate-600">{fmtBRL(r.cost_price)}</TableCell>
                        <TableCell className="border border-slate-200 px-3 py-3 text-slate-600">
                          {margin !== '—' ? (
