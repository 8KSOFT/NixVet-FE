      ...
      <div className="bg-white rounded-sm overflow-hidden">
        <div className="divide-y max-h-[65vh] overflow-y-auto border-gray-300">
          {HOURS.map((h) => {
            ...
            return (
              <div key={h} className="flex min-h-12 border-gray-300">
                ...
                <div className="flex-1 border-l border-gray-300 px-2 py-1 space-y-0.5">
                  {hourItems.map((c) => (
                    <div
                      key={c.id}
                      className={cn(
                    ...
                    >
                      ...
                      {c.patient?.name} ({c.veterinarian?.name})
                    </div>
                  ))}
                  {hourGoogle.map((e) => (
                    <div
        ...
        {calendarDays.map((day, idx) => {
          ...
          return (
            <div
              key={idx}
              className={cn(
                "border-r border-b border-gray-300 min-h-[80px] p-1 hover:bg-muted/50",
                !isCur && "bg-muted/50",
                isSel && "bg-primary/10",
              )}
              onClick={() => {
                ...
                <div className="border border-primary/30 rounded-lg p-3 bg-primary/5 space-y-3">
                  ...
                  >
                    {creatingPatient ? (
                      ...
                      <>
                        <CheckCircle2 className="w-3.5 h-3.5 mr-2" /> Salvar pet
                        e continuar
                      </>
                    )}
                  </Button>
